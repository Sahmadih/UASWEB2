                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="nama_makul" class="form-control" placeholder="Tambahkan Nama Matakuliah Makul" value="{{ is_null($makul) ? '' : $makul->nama_makul }}">
                                </div>
                                <div class="col">
                                    <label for="">SKS</label>
                                    <input type="number" name="sks" class="form-control" placeholder="Tambahkan SKS Matakuliah Makul" value="{{ is_null($makul) ? '' : $makul->sks }}">
                                </div>
                            </div>
                        </div>
